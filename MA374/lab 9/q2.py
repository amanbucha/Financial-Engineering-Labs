...
files = ['NIFTYoptiondata', 'stockoptiondata_ITC', 'stockoptiondata_SBI', 'stockoptiondata_TCS', 'stockoptiondata_TITAN']
opt_type = ['NSE Index', 'ITC', 'SBI', 'TCS', 'TITAN']
print("Part A")
...
files = ['stockoptiondata_ITC', 'stockoptiondata_SBI', 'stockoptiondata_TCS', 'stockoptiondata_TITAN']
opt_type = ['ITC', 'SBI', 'TCS', 'TITAN']
print("For Part B")
for idx in range(len(files)):
  files[idx] = './' + files[idx] + '.csv'
