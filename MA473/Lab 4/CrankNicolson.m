function [U, U_ut, x, x_ut, t] = CrankNicolson(N, M, x, t, lambda, dx, dt, T, r, sigma, delta, f1, f2, g, a, b, c, d, m)
    ...
    for j = 2 : M + 1
        ...
        elseif m == "Conjugate Gradient method"
            u = conjugate_gradient_method(A, L * (U(j - 1, 2 : end - 1)') + B, 200, 0.001);
        else
