function vega = get_vega(N, M, x, t, lambda, dx, dt, K, T, r, sigma, delta, f1, f2, g, a, b, c, d, m, idx)
    ...
    U_plus = schemes{idx}(N, M, x, flip(t), lambda, dx, -dt, K, T, r, sigma+del_sigma, delta, f1, f2, g, a, b, c, d, m);
    U_minus = schemes{idx}(N, M, x, flip(t), lambda, dx, -dt, K, T, r, sigma-del_sigma, delta, f1, f2, g, a, b, c, d, m);
